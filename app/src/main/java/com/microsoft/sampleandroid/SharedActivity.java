...
public class SharedActivity extends AppCompatActivity {
    ...
    private static final String SharingAnchorsServiceUrl = <ENTER_YOUR_URL_SERVICE>;
    ...
    public void locateButtonClicked(View source) {
        if (currentStep == DemoStep.DemoStepChoosing) {
            ...
            if (!inputVal.isEmpty()) {
                ...
                // Creamos el servicio que recupera el anchor, pasándole la URL y un callback
                AnchorGetter anchorExchanger = new AnchorGetter(SharingAnchorsServiceUrl, this::anchorLookedUp);
                // Lo ejecutamos pasándole como arguemnto el número del anchor que queremos recuperar
    ...
    private void anchorLookedUp(String anchorId) {
        ...
        //Callback llamado cuando finaliza el thread que recupera la informacion del sercio web
        // El servicio web nos devuelve el anchor id -> le pasamos un número y nos devuelve un id
    ...
    private void anchorPosted(String anchorNumber) {
        ...
        textView.setText(getString(R.string.anchorid, anchorNumber));
    ...
    private void transitionToSaving(AnchorVisual visual) {
        ...
        cloudAnchorManager.createAnchorAsync(cloudAnchor)
                .thenAccept(anchor -> {
                    ...
                    // Creamos el poster, que será lo que envía los datos (cloud anchor id) al servicio web
                    // Añadimos la url del servicio, y un callback que se llamará cuando acabe la ejecución
